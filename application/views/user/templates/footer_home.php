            ...
            <div class="row" id="rowFooter">
              ...
              <div class="col-md-2">
                 <p id="titleFooter-ext"> CUSTOMER SERVICE</p>
                  <img src="/asset/user/img/call-center.png" class="img-responsive">
              ...
              <div class="col-md-3">
                ...
                <a href="<?=base_url();?>info/panduan/" class="btn btn-primary btn-md btn-block">Tentang Kami</a>
...
$(function(){
  ...
  $("#keyword").autocomplete({
    source: "<?= site_url('produk/autocomplete/GetDataProduk');?>", 
    minLength : 3,
        dataType:'JSON',
        type:'POST',
...
s1.async=true;
s1.src='https://embed.tawk.to/55743be3e93587bc57f6cb8e/default';
s1.charset='UTF-8';
