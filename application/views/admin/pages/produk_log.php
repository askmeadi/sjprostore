...
<?php } ?>
          ...
          <form action="<?php echo site_url('admin/log/delete_produk');?>" method="post">
          ...
          <table class="table table-bordered table-striped tablesorter" id="myTable">
            ...
            <tbody>
                <?php foreach ($produk_log as $data) {?>
            <tr>
            <td><center><input type="checkbox" id="cekbox" name="cekbox[]" value="<?= $data['id_produk_log'];?>"/></center></td>
